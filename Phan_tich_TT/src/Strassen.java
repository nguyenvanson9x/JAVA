...
public class Strassen {
	...
	public int[][] multiply(int[][] A, int[][] B) {
		...
		if (n == 1)
			...
			int[][] M1 = multiply(add(A11, A22), add(B11, B22));// p5
			int[][] M2 = multiply(add(A21, A22), B11);// p3
			int[][] M3 = multiply(A11, sub(B12, B22));// p1
			int[][] M4 = multiply(A22, sub(B21, B11));// p4
			int[][] M5 = multiply(add(A11, A12), B22);// p2
			int[][] M6 = multiply(sub(A21, A11), add(B11, B12));// p7
			int[][] M7 = multiply(sub(A12, A22), add(B21, B22));// p6

			/**
			 * C11 = M1 + M4 - M5 + M7 = p5 + p4 - p2 + p6 C12 = M3 + M5 = p1 +
			 * p2 C21 = M2 + M4 = p3 + p4 C22 = M1 - M2 + M3 + M6 = p5 - p3 + p1
			 * + p7
			 **/
