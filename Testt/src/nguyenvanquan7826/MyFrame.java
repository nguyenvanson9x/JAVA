...
public class MyFrame extends JFrame implements ActionListener {
	...
	private JPanel creatPaintPanel() {
		...
		icon = new ImageIcon(getClass().getResource(link + "iconOk.png"));
		drawPanel.add(btnUpdate = createButtonImage(icon, "Update Graph"));

		icon = new ImageIcon(getClass().getResource(link + "iconPoint.png"));
		drawPanel.add(btnPoint = createButtonImage(icon, "Draw Point"));

		icon = new ImageIcon(getClass().getResource(link + "iconLine.png"));
		drawPanel.add(btnLine = createButtonImage(icon, "Draw line"));

		icon = new ImageIcon(getClass().getResource(link + "iconMove.png"));
		drawPanel.add(btnMove = createButtonImage(icon, "Move Point"));

		icon = new ImageIcon(getClass().getResource(link + "iconOpen.png"));
		drawPanel.add(btnOpen = createButtonImage(icon, "Open graph"));

		icon = new ImageIcon(getClass().getResource(link + "iconSave.png"));
		drawPanel.add(btnSave = createButtonImage(icon, "Save graph"));

		icon = new ImageIcon(getClass().getResource(link + "iconNew.png"));
	...
	private void showHelp() {
		if (frameHelp == null) {
			frameHelp = new JFrame("Dijkstra - Help");
		}
	...
	private void showAbout() {
		if (frameAbout == null) {
			frameAbout = new JFrame("Dijkstra - About");
		}
